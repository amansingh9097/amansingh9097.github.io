...
headerImage: true
projects: true
description: "A realtime object detection model built using MobileNetSSD Caffemodel."
category: deep-learning
author: Aman Singh
externalLink: false
---

A realtime object detection model built using MobileNetSSD Caffemodel.

Check out the whole project [here](https://github.com/amansingh9097/realtime-object-detection).
