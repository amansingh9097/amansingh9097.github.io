...
description: "A text summarizer for the lazy folks like myself"
category: machine-learning
author: Aman Singh
externalLink: false
---

A Too Long Didn't Read (TL-DR) Text Summarizer for lazy folks like myself.

Check out the whole project [here](https://github.com/amansingh9097/TL-DR-text-summarizer).
